 ...
 <section className="container mx-auto px-4 py-12">
  ...
  <div className="overflow-x-auto">
    <table className="w-full border border-gray-300 rounded-lg shadow">
      ...
      <tbody>
        {[
          { type: "Ground Floor", size: "19x40" },
          { type: "Ground Floor + 1", size: "19x40" },
          { type: "Ground Floor", size: "20x38" },
          { type: "Ground Floor + 1", size: "20x38" },
  ...
  <div className="text-center mt-6">
    ...
    <a
      href="https://wa.me/917359504990?text=Hello%20Madhav%20Reality%2C%20I%20want%20to%20inquire%20about%20Ashirvad%20Glory."
      target="_blank"
