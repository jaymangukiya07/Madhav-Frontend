// src/pages/AshirvadVillaDetail.jsx
import { FaMapMarkerAlt, FaDownload, FaCheckCircle } from "react-icons/fa";
import PageTransition from "../../components/PageTransition";

export default function AshirvadVillaDetail() {
  return (
    <PageTransition>
    <div className="bg-white text-gray-800 mt-40">
      ...
      <section className="relative bg-gradient-to-r from-yellow-100 via-yellow-50 to-white py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg max-w-2xl">
            Welcome to Ashirvad Villa — a premium villa project offering
            luxurious spaces, modern architecture, and peaceful surroundings,
            designed for an elegant and comfortable lifestyle.
          </p>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-700 leading-relaxed">
          Ashirvad Villa is a collection of premium residential villas built
          with attention to detail and top-notch quality. Located in a
          well-connected yet serene area, the project offers spacious interiors,
          landscaped surroundings, and state-of-the-art facilities for those who
 ...
 <section className="container mx-auto px-4 py-12">
  ...
  <div className="overflow-x-auto">
    <table className="w-full border border-gray-300 rounded-lg shadow">
      ...
      <tbody>
        {[
          { type: "Ground Floor", size: "13x40" },
          { type: "Ground Floor + 1", size: "13x40" },
          { type: "Ground Floor", size: "18x40" },
          { type: "Ground Floor + 1", size: "18x40" },
  ...
  <div className="text-center mt-6">
    ...
    <a
      href="https://wa.me/919586640380?text=Hello%20Madhav%20Reality%2C%20I%20want%20to%20inquire%20about%20Ashirvad%20villa."
      target="_blank"
    ...
    >
      ...
      <section className="text-center py-12 flex flex-col items-center gap-4">
        <a
          href="/brochures/ashirvad-villa-brochure.pdf"
          download
        ...
        <a
          href="https://maps.app.goo.gl/ocDhQfiVMGA1gEXk7"
          target="_blank"
          rel="noopener noreferrer"
