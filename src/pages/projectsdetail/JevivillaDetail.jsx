...
export default function JevivillaDetail() {
 ...
 <section className="container mx-auto px-4 py-12">
    ...
    <table className="w-full border border-gray-300 rounded-lg shadow">
      ...
      <tbody>
        {[
          ...
          { type: "Open Plot", size: "20x38" },
          { type: "Open Plot", size: "20x40" },
        ].map((item, index) => (
  ...
  <div className="text-center mt-6">
    ...
    <a
      href="https://wa.me/919979231280?text=Hello%20Madhav%20Reality%2C%20I%20want%20to%20inquire%20about%20jevi%20villa."
      target="_blank"
