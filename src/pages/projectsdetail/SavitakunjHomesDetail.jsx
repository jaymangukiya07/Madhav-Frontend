// src/pages/SavitakunjHomesDetail.jsx
import { FaMapMarkerAlt, FaDownload, FaCheckCircle } from "react-icons/fa";
import PageTransition from "../../components/PageTransition";

export default function SavitakunjHomesDetail() {
  return (
    <PageTransition>
    <div className="bg-white text-gray-800 mt-40">
      ...
      <section className="relative bg-gradient-to-r from-yellow-100 via-yellow-50 to-white py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg max-w-2xl">
            Savitakunj Homes offers a premium lifestyle with modern architecture,
            lush green surroundings, and excellent connectivity — the perfect
            choice for families seeking comfort and elegance.
          </p>
        </div>
      </section>
      ...
      <section className="mb-10 container mx-auto px-4">
        ...
        <p className="text-gray-700 leading-relaxed">
          Nestled in a serene yet well-connected location, Savitakunj Homes
          combines contemporary design with functional layouts. From landscaped
          gardens to modern security systems, every detail is crafted to enhance
 ...
 <section className="container mx-auto px-4 py-12">
  ...
  <div className="overflow-x-auto">
    <table className="w-full border border-gray-300 rounded-lg shadow">
      ...
      <tbody>
        {[
          { type: "Ground Floor", size: "21x43" },
          { type: "Ground Floor + 1", size: "21x43" },
  ...
  <div className="text-center mt-6">
    ...
    <a
      href="https://wa.me/917698517197?text=Hello%20Madhav%20Reality%2C%20I%20want%20to%20inquire%20about%20Savitakunj%20Homes."
      target="_blank"
    ...
    >
      ...
      <section className="text-center py-12 flex flex-col items-center gap-4">
        <a
          href="/brochures/savita-kunj-homes-brochure.pdf"
          download
        ...
        <a
          href="https://maps.app.goo.gl/DvSe6bm18eraQoZP7"
          target="_blank"
          rel="noopener noreferrer"
