 ...
 <section className="container mx-auto px-4 py-12">
  ...
  <div className="overflow-x-auto">
    <table className="w-full border border-gray-300 rounded-lg shadow">
      ...
      <tbody>
        {[
          { type: "Ground Floor", size: "22x40" },
          { type: "Ground Floor + 1", size: "22x40" },
  ...
  <div className="text-center mt-6">
    ...
    <a
      href="https://wa.me/919898929858?text=Hello%20Madhav%20Reality%2C%20I%20want%20to%20inquire%20about%20Adarsh%20Bunglows."
      target="_blank"
