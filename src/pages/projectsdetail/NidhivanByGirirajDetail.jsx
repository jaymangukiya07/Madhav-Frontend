...
export default function NidhivanByGirirajDetail() {
 ...
 <section className="container mx-auto px-4 py-12">
    ...
    <table className="w-full border border-gray-300 rounded-lg shadow">
      ...
      <tbody>
        {[
          ...
          { type: "Ground Floor", size: "14x42" },
          { type: "Ground Floor + 1", size: "14x42" },
          { type: "Ground Floor", size: "24x60" },
          { type: "Ground Floor + 1", size: "24x60" },
          { type: "Open Plot", size: "14x40" },
          { type: "Open Plot", size: "14x42" },
          { type: "Open Plot", size: "24x60" },
        ].map((item, index) => (
  ...
  <div className="text-center mt-6">
    ...
    <a
      href="https://wa.me/919979231280?text=Hello%20Madhav%20Reality%2C%20I%20want%20to%20inquire%20about%20NidhivanbyGiriraj."
      target="_blank"
